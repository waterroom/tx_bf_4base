...
module tb_tx_top;
    ...
    initial begin
        ...
        $display("[cfg] beam0 w_re: %0d %0d %0d %0d %0d %0d %0d %0d",
            ...
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[1],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[2],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[3],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[4],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[5],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[6],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.w_re[7]);
        $display("[cfg] beam1 w_re: %0d %0d %0d %0d %0d %0d %0d %0d",
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[0],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[1],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[2],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[3],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[4],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[5],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[6],
            u_dut.u_tx.g_beam[1].u_beam.u_bf_core.w_re[7]);
        $display("[cfg] beam2 w_re: %0d %0d %0d %0d %0d %0d %0d %0d",
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[0],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[1],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[2],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[3],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[4],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[5],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[6],
            u_dut.u_tx.g_beam[2].u_beam.u_bf_core.w_re[7]);
        $display("[cfg] beam3 w_re: %0d %0d %0d %0d %0d %0d %0d %0d",
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[0],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[1],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[2],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[3],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[4],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[5],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[6],
            u_dut.u_tx.g_beam[3].u_beam.u_bf_core.w_re[7]);
        $display("[cfg] beam0 fir7: %0d %0d %0d %0d %0d %0d %0d %0d",
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[1].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[2].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[3].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[4].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[5].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[6].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[7]);
        ...
        $display("[cfg] ch0 coef: %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d",
            ...
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[1],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[2],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[3],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[4],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[5],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[6],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[8],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[9],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[10],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[11],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[12],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[13],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[14],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[0].u_fir.coef[15]);
        $display("[cfg] ch7 coef: %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d %0d",
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[0],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[1],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[2],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[3],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[4],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[5],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[6],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[7],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[8],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[9],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[10],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[11],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[12],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[13],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[14],
            u_dut.u_tx.g_beam[0].u_beam.u_bf_core.g_ch[7].u_fir.coef[15]);
